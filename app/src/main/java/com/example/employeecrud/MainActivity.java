    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (stringName.length() <=0 || stringEmail.length() <=0||stringPhone.length() <=0) {
                    ...
                    EmployeeModelClass employeeModelClass = new EmployeeModelClass(stringName,stringEmail,stringPhone);
