...
public class DatabaseHelperClass extends SQLiteOpenHelper {
    ...
    //Database Table name
    private static final String TABLE_NAME = "EMPLOYEEE";
    //Table columns
    ...
    private static final String CREATE_TABLE = "create table " + TABLE_NAME +"("+ID+
            " INTEGER PRIMARY KEY AUTOINCREMENT," + NAME + " TEXT ,"+EMAIL+" TEXT ,"+PHONE+" TEXT );";
    //Constructor
    ...
    public void addEmployee(EmployeeModelClass employeeModelClass){
        ...
        contentValues.put(DatabaseHelperClass.PHONE, employeeModelClass.getPhone());
    ...
    public List<EmployeeModelClass> getEmployeeList(){
        ...
        if (cursor.moveToFirst()){
            do {
                ...
                storeEmployee.add(new EmployeeModelClass(id,name,email,phone));
